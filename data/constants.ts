...
export const KEY_FINDINGS = [
  ...
  },
  {
    ...
    description:
      "<strong>July recorded the highest monthly backlink acquisition to date</strong>, with 108 new backlinks bringing the total to 346.",
    icon: "fas fa-trophy",
  ...
  },
  {
    ...
    description:
      "<strong>Competitor keywords continue to perform well</strong>, with 'teamviewer pricing' and 'anydesk pricing' ranking in the top 5, while 'teamviewer alternative' maintains a first-page position.",
  ...
  },
  {
    ...
    description:
      "<strong>Informational keywords continue to strengthen</strong>, with 'remote desktop' ranking in the top 3, 'remote access' maintaining a top 5 position, and 'patch management' securing a first-page ranking.",
